...
import unicauca.edu.co.sga.common_utilities_service.application.dto.response.StudentView.*;
import unicauca.edu.co.sga.common_utilities_service.application.ports.RubricEvaluationPort;
import unicauca.edu.co.sga.common_utilities_service.domain.exceptions.RubricEvaluation.EmptyReturnException;
import unicauca.edu.co.sga.common_utilities_service.infrastructure.persistence.entities.CalificationRegisterEntity;
import unicauca.edu.co.sga.common_utilities_service.infrastructure.persistence.entities.CriteriaEntity;
import unicauca.edu.co.sga.common_utilities_service.infrastructure.persistence.repositories.CalificationRegisterRepository;
import unicauca.edu.co.sga.common_utilities_service.infrastructure.persistence.repositories.CriteriaRepository;
import unicauca.edu.co.sga.common_utilities_service.infrastructure.persistence.repositories.EnrollRepository;
import unicauca.edu.co.sga.common_utilities_service.infrastructure.persistence.repositories.RubricRepository;
