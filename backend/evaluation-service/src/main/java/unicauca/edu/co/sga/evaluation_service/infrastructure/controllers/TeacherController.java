...
import unicauca.edu.co.sga.evaluation_service.domain.exceptions.teacher.TeacherAlreadyExistException;
import unicauca.edu.co.sga.evaluation_service.domain.exceptions.teacher.TeacherNotFoundException;
...
public class TeacherController {
    ...
    public ResponseEntity<TeacherResponseDTO> createTeacher(@Valid @RequestBody TeacherRequestDTO teacherRequestDTO){
        ...
        if (teacherExist.isPresent()){
            throw new TeacherAlreadyExistException("Teacher with Identification " + teacherExist.get().getIdentification() + " already exist.");
        }
    ...
    public ResponseEntity<TeacherResponseDTO> getTeacherByCourseId(@PathVariable Long id){
        ...
        if (teacher.isEmpty()){
            throw new TeacherNotFoundException("Teacher with Course ID " + id + " not found.");
        }
    ...
    public ResponseEntity<TeacherResponseDTO> getTeacherByIdentification(@PathVariable Long id){
        ...
        if (teacher.isEmpty()){
            throw new TeacherNotFoundException("Teacher with identification " + id + " not found.");
        }
